...
import 'package:flutter_anime_characters/screens/character_detail.dart';
...
class AnimeCharacterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTapDown: (details) => Navigator.of(context).pushNamed(
          CharacterDetailScreen.routeName,
          arguments: CharacterDetailArgs(character: character)),
      child: Container(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Column(
                        children: character.skills.map((e) => Text(e)).toList())
                  ],
                ),
              )
            ]),
